...
<section class="closing-invitation" aria-labelledby="invitation-heading">
    ...
    <div>
        <p>You don’t need to arrive with a software specification. An example of something that’s harder than it ought to be is a useful place to start. The hour is about your work, not a pitch.</p>
