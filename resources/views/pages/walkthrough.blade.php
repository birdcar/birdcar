...
<x-marketing.layout title="Book a free Walkthrough" active="walkthrough" description="Find out what’s making work harder than it needs to be. A free, hour-long Walkthrough of the work with me and a written report of recommended improvements, yours to keep.">
    <section class="offer-opening" aria-labelledby="offer-heading">
        <div class="offer-copy">
            ...
            <p>In a free Walkthrough, I’ll spend about an hour getting to know the work that’s giving you trouble. Afterward, I’ll write up the problems I’ve understood and the improvements I recommend.</p>
    ...
    <section class="assessment-faq section-space" aria-labelledby="questions-heading">
        ...
        <div>
            <details><summary>Is the Walkthrough really free?<x-marketing.arrow /></summary><p>Yes. The conversation and the written report are free. You don’t have to buy implementation to receive or use the report.</p></details>
            ...
            <details><summary>Is this an AI project?<x-marketing.arrow /></summary><p>It’s a Walkthrough of your work. AI might be useful, and so might connecting the tools you already use or changing a process. I’ll recommend what makes sense for the problem.</p></details>
        </div>
    </section>
