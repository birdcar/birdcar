...
?>
<x-marketing.layout title="Book a free Walkthrough" active="walkthrough" description="Find out what’s making work harder than it needs to be. A free, hour-long Walkthrough of the work with me and a written report of recommended improvements, yours to keep.">
    <section class="offer-opening" aria-labelledby="offer-heading">
        <div class="offer-copy">
            ...
            <p>When you’re the person keeping track of everything, it’s hard to step back far enough to see what needs to change. I’ll take a closer look with you. I start with the people doing the work, not with software.</p>
            <p>In a free Walkthrough, you spend about an hour showing me the work that’s giving you trouble. Afterward, you get the problems I’ve understood and the improvements I recommend, in writing, within three business days.</p>
    ...
    <section class="offer-steps section-space" aria-labelledby="meeting-heading">
        ...
        <ol>
            ...
            <li><span class="step-number">2</span><div><h3>Walk me through it.</h3><p>You walk me through how the work happens, who’s involved, and where it gets difficult. You get questions until the problem makes sense in its context.</p></div></li>
            <li><span class="step-number">3</span><div><h3>Keep the report.</h3><p>After the conversation, you get my observations and recommendations in writing, within three business days, to use on your own or with my help.</p></div></li>
        </ol>
    </section>
    ...
    <section class="offer-close" id="choose-a-time" aria-labelledby="book-heading">
        ...
        <p>Pick an hour that suits you. A conversation with me, then practical recommendations in writing, within three business days.<br>Yours to use however you choose.</p>
