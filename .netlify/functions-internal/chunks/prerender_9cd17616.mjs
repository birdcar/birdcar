/* empty css                              */import { A as AstroError, C as CollectionDoesNotExistError, f as UnknownContentCollectionError, b as createComponent, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderTemplate, j as renderComponent, u as unescapeHTML, c as createAstro, e as addAttribute, m as maybeRenderHead, s as spreadAttributes, k as renderSlot, l as renderHead, _ as __astro_tag_component__, F as Fragment, n as createVNode } from './astro_c3305d12.mjs';
import 'clsx';
import rss from '@astrojs/rss';
import sharp from 'sharp';
import { p as prependForwardSlash } from './pages/image-endpoint_89c28a59.mjs';
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/first-post.md": () => import('./first-post_d14acc6e.mjs'),"/src/content/blog/markdown-style-guide.md": () => import('./markdown-style-guide_2aaba126.mjs'),"/src/content/blog/second-post.md": () => import('./second-post_d7050777.mjs'),"/src/content/blog/third-post.md": () => import('./third-post_985b0322.mjs'),"/src/content/blog/using-mdx.mdx": () => import('./using-mdx_09a3fb12.mjs')
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"first-post":"/src/content/blog/first-post.md","second-post":"/src/content/blog/second-post.md","markdown-style-guide":"/src/content/blog/markdown-style-guide.md","third-post":"/src/content/blog/third-post.md","using-mdx":"/src/content/blog/using-mdx.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/first-post.md": () => import('./first-post_a20bbf3b.mjs'),"/src/content/blog/markdown-style-guide.md": () => import('./markdown-style-guide_c27e976f.mjs'),"/src/content/blog/second-post.md": () => import('./second-post_670c199a.mjs'),"/src/content/blog/third-post.md": () => import('./third-post_12b3f320.mjs'),"/src/content/blog/using-mdx.mdx": () => import('./using-mdx_6a10f7dd.mjs')
...
const SITE_TITLE = "Birdcar.dev";
const SITE_DESCRIPTION = "Support professional, founder, product malcontent";

const $$Astro$9 = createAstro("https://example.com");
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$9, $$props, $$slots);
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<div class="grid items-center grid-cols-12 grid-rows-1 p-4"><header><h2 class="text-2xl font-semibold hover:text-red-600 hover:dark:text-red-400"><a href="/">${SITE_TITLE}</a></h2></header><nav class="col-start-6 col-span-2 flex justify-around space-x-4">${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/uses", "class": "hover:text-zinc-400 font-semibold" }, { "default": ($$result2) => renderTemplate`
Uses
` })}${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/feed.xml", "class": "hover:text-zinc-400 font-semibold" }, { "default": ($$result2) => renderTemplate`
RSS
` })}</nav></div>`;
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="text-center">
&copy; ${today.getFullYear()} Birdcar.dev. All rights reserved.
<div class="flex justify-center gap-4 mt-4"><a href="https://github.com/birdcar/birdcar" class="" target="_blank"><span class="sr-only">Go to Birdcar's GitHub repo</span><svg viewBox="0 0 16 16" aria-hidden="true" width="32" height="32" astro-icon="social/github"><path fill="currentColor" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></footer>`;
...
const $$BaseLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="h-full"><head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": SITE_TITLE, "description": SITE_DESCRIPTION })}${renderHead()}</head><body class="h-full bg-gray-50 text-zinc-900 selection:bg-yellow-200 selection:text-yellow-900 dark:bg-zinc-900 dark:text-zinc-50"><div class="max-w-7xl mx-auto">${renderComponent($$result, "Header", $$Header, { "title": SITE_TITLE })}</div><main class="mx-auto max-w-7xl p-4">${renderSlot($$result, $$slots["default"])}</main>${renderComponent($$result, "Footer", $$Footer, {})}</body></html>`;
...
const $$FormattedDate = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { date, ...props } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<time${addAttribute(date.toISOString(), "datetime")}${spreadAttributes(props)}>${date.toLocaleDateString("en-us", {
    year: "numeric",
    month: "short",
    day: "2-digit"
  })}</time>`;
...
const $$PostListItem = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$5, $$props, $$slots);
  Astro2.self = $$PostListItem;
  const { post } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<article class="group relative flex items-center">${renderComponent($$result, "FormattedDate", $$FormattedDate, { "date": post.data.pubDate, "class": "mr-2 min-w-min text-sm uppercase text-red-600 dark:text-red-400" })}<h3 class="text-lg flex-1 font-semibold truncate group-hover:text-zinc-500 group-hover:dark:text-zinc-400">${post.data.title}</h3><p class="text-zinc-500 text-xs min-w-min uppercase">2 min</p><a class="absolute top-0 right-0 bottom-0 left-0"${addAttribute(`/blog/${post.slug}`, "href")}${addAttribute(post.data.title, "aria-label")}></a></article>`;
}, "/Users/birdcar/Code/birdcar/blog/src/components/PostListItem.astro", void 0);
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<section class="mx-auto my-12 max-w-4xl flex flex-col justify-center items-center border-b-2 border-zinc-300 border-opacity-30 pb-12"><img src="https://github.com/birdcar.png" alt="Birdcar profile picture" class="mb-6 h-32 w-32 rounded-lg shadow-xl shadow-zinc-200 dark:shadow-zinc-800"><p class="text-center max-w-lg">${SITE_DESCRIPTION}</p></section><section class="mx-auto my-12 max-w-4xl"><div class="space-y-4">${posts.map((post) => renderTemplate`${renderComponent($$result2, "PostListItem", $$PostListItem, { "post": post })}`)}</div></section>` })}`;
...
const $$file$2 = "/Users/birdcar/Code/birdcar/blog/src/pages/blog/index.astro";
const $$url$2 = "/blog";
...
const $$file$1 = "/Users/birdcar/Code/birdcar/blog/src/pages/blog/[...slug].astro";
...
}, "/Users/birdcar/Code/birdcar/blog/src/pages/uses.astro", void 0);

const $$file = "/Users/birdcar/Code/birdcar/blog/src/pages/uses.astro";
const $$url = "/uses";

const uses = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$Uses,
  file: $$file,
  url: $$url
...
export { ____slug_ as _, index as a, __vite_glob_0_0 as b, __vite_glob_0_1 as c, __vite_glob_0_2 as d, __vite_glob_0_3 as e, __vite_glob_0_4 as f, ____route_ as g, index$1 as i, rss_xml as r, uses as u };
