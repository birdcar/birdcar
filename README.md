...
Solutions Engineer at [**WorkOS**](https://workos.com). Based in Fort Worth, TX.

I write about software at [birdcar.dev](https://www.birdcar.dev) using [Birdcar Flavored Markdown](https://github.com/birdcar/markdown-spec), a CommonMark superset I maintain.
...
- [**birdcar.dev**](https://www.birdcar.dev) — personal blog, built with Astro
- [**Birdcar Flavored Markdown**](https://github.com/birdcar/markdown-spec) — CommonMark superset with directives, extended task lists, mentions, and more
- [**bfm.nvim**](https://github.com/birdcar/bfm.nvim) — Neovim plugin for BFM: completions, task cycling, folding, concealing

#### Latest blog posts

<!-- BLOG-POST-LIST:START -->
- [Your AI wrote a bug](https://www.birdcar.dev/writing/your-ai-wrote-a-bug/) — Apr 17, 2026
- [The tools that build the tools](https://www.birdcar.dev/writing/the-tools-that-build-the-tools/) — Apr 10, 2026
- [Six months of talking to a machine](https://www.birdcar.dev/writing/six-months-talking-to-a-machine/) — Apr 3, 2026
- [The other side of empathy](https://www.birdcar.dev/writing/the-other-side-of-empathy/) — Sep 25, 2024
- [Your metrics are bullshit](https://www.birdcar.dev/writing/your-metrics-are-bullshit/) — May 1, 2024
<!-- BLOG-POST-LIST:END -->

---

**Currently into:** Python, TypeScript, Neovim, Astro

[Blog](https://www.birdcar.dev) · [WorkOS](https://workos.com)
